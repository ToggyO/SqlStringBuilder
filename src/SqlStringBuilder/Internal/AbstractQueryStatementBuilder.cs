...
namespace SqlStringBuilder.Internal
{
	...
	{
		private readonly LinkedList<AbstractComponent> _components = new ();
		...
		List<object> IInternalBaseQueryStatementBuilder<TQuery>.Bindings => _bindings;
		...
		/// <inheritdoc cref="IInternalBaseQueryStatementBuilder{TQuery}.Bindings"/>.
		internal List<object> Bindings => _bindings;
