...
namespace SqlStringBuilder.Internal.BaseQuery
{
	...
	internal abstract partial class BaseQueryStatementBuilder<TQuery> : IWhereQueryStatementBuilder
	{
		...
		/// <inheritdoc cref="IWhereQueryStatementBuilder.WhereNotNull(string)"/>.
		public IWhereQueryStatementBuilder WhereNotNull(string columnName) => Not().WhereNull(columnName);

		/// <inheritdoc cref="IWhereQueryStatementBuilder.OrWhereNotNull(string)"/>.
		public IWhereQueryStatementBuilder OrWhereNotNull(string columnName) => Or().Not().WhereNull(columnName);
	}
}