namespace SqlStringBuilder.Interfaces.Common
{
    public interface IWhereQueryStatementBuilder : IBaseQueryStatementBuilder
    {
		...
		/// <summary>
		/// Perform a sub query where clause in comparison with "NOT NULL".
		/// </summary>
		/// <param name="columnName">Column name.</param>
		/// <returns></returns>
		IWhereQueryStatementBuilder WhereNotNull(string columnName);

		/// <summary>
		/// Perform a sub query where clause in comparison with "NOT NULL" as "OR".
		/// </summary>
		/// <param name="columnName">Column name.</param>
		/// <returns></returns>
		IWhereQueryStatementBuilder OrWhereNotNull(string columnName);
